    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          if((conv_mxt4x4_3(UNITY_MATRIX_P).w==0))
          {
              ...
              scale_6 = lerp((scale_6 * (1 - _PerspectiveFilter)), scale_6, abs(dot(normalize(mul(in_v.normal, tmpvar_13)), normalize((_WorldSpaceCameraPos - mul(unity_ObjectToWorld, vert_8).xyz)))));
          }
          ...
          float4 tmpvar_19;
          float _tmp_dvx_40 = sqrt(min(1, (tmpvar_15 * 2)));
          tmpvar_19 = lerp(faceColor_4, outlineColor_3, float4(_tmp_dvx_40, _tmp_dvx_40, _tmp_dvx_40, _tmp_dvx_40));
          ...
          float4 tmpvar_21;
          tmpvar_21.xy = vert_8.xy;
          float _tmp_dvx_41 = (0.5 / pixelSize_7);
          tmpvar_21.zw = float2(_tmp_dvx_41, _tmp_dvx_41);
          float4 tmpvar_22;
          float4 tmpvar_23;
          tmpvar_22 = tmpvar_20;
          tmpvar_23 = tmpvar_21;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float tmpvar_5;
          tmpvar_5 = (tmpvar_4.w * in_f.xlv_TEXCOORD1.x);
          float tmpvar_6;
          tmpvar_6 = clamp((tmpvar_5 - in_f.xlv_TEXCOORD1.z), 0, 1);
          float tmpvar_7;
          tmpvar_7 = clamp((tmpvar_5 - in_f.xlv_TEXCOORD1.y), 0, 1);
          c_3 = (lerp(in_f.xlv_COLOR1, in_f.xlv_COLOR, float4(tmpvar_6, tmpvar_6, tmpvar_6, tmpvar_6)) * tmpvar_7);
          float2 tmpvar_8;
          tmpvar_8 = ((_ClipRect.zw - _ClipRect.xy) * 0.5);
          clipSize_2 = tmpvar_8;
          float2 tmpvar_9;
          tmpvar_9 = (_ClipRect.xy + clipSize_2);
          clipCenter_1 = tmpvar_9;
          if(_UseClipRect)
          {
              float2 m_10;
              float2 s_11;
              float2 tmpvar_12;
              tmpvar_12.x = _MaskSoftnessX;
              tmpvar_12.y = _MaskSoftnessY;
              float2 tmpvar_13;
              tmpvar_13 = (tmpvar_12 * in_f.xlv_TEXCOORD2.zw);
              s_11 = tmpvar_13;
              float2 tmpvar_14;
              tmpvar_14 = (1 - clamp(((((abs((in_f.xlv_TEXCOORD2.xy - clipCenter_1)) - clipSize_2) * in_f.xlv_TEXCOORD2.zw) + s_11) / (1 + s_11)), 0, 1));
              m_10 = (tmpvar_14 * tmpvar_14);
              c_3 = (c_3 * (m_10.x * m_10.y));
          }
          out_f.color = c_3;
          return out_f;
      }
