namespace Soomla.Store
{
	public class CurrencyBalanceChangedEvent : SoomlaEvent
	{
		...
		public CurrencyBalanceChangedEvent(VirtualCurrency item, int balance, int amountAdded)
			: this(item, balance, amountAdded, null)
		{
		}

		public CurrencyBalanceChangedEvent(VirtualCurrency item, int balance, int amountAdded, object sender)
			: base(sender)
		{
			mItem = item;
			mBalance = balance;
