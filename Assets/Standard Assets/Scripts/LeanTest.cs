...
public class LeanTest
{
	...
	{
		testsFinished = true;
		UnityEngine.Debug.Log(formatB("Final Report:") + " _____________________ PASSED: " + formatBC(string.Empty + passes, "green") + " FAILED: " + formatBC(string.Empty + (expected - passes), "red") + " ");
	}
}
