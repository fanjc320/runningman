...
public class LTDescr
{
	...
	[Obsolete("Use 'cancel( gameObject )' instead")]
	...
	public void init()
	{
		...
		case TweenAction.MOVE_LOCAL_Z:
		{
			...
			reference12.x = localPosition3.z;
			break;
		}
			...
			else if (trans.childCount > 0)
			{
				...
				try
				{
					while (enumerator2.MoveNext())
					{
						...
						{
							Color color10 = transform2.gameObject.GetComponent<Renderer>().material.color;
							from.x = color10.a;
							break;
						}
					}
			...
			else if (trans.childCount > 0)
			{
				...
				try
				{
					while (enumerator.MoveNext())
					{
						...
						{
							Color color6 = transform.gameObject.GetComponent<Renderer>().material.color;
							setFromColor(color6);
							break;
						}
					}
